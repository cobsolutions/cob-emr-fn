  ...
  */
  ...
  private mapBasicToModel(basic: any): Basic {
    const mapped: Basic = {
      ...
      specificPhysicianRdersText: basic.specific_physician_rders === 'yes' ? basic.specific_physician_rders_text : undefined,
      ...
      currentComplaintsGains: basic.current_complaints_gains
    };
    return mapped;
  }
  ...
  private mapBasicFromDto(basic: any): any {
    const mapped: any = {
      ...
      current_complaints_gains: basic.currentComplaintsGains
    };
