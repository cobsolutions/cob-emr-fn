...
export class SelfCareMapper {
  public static map(formGroup: FormGroup, mapped: CurrentFunction, getValue: (controlName: string) => any): void {
    ...
    const selfCareFlag = getValue('current-level-function_self-care');
    ...
    // Self Care - Hygiene
    const hygieneFlag = getValue('current-level-function_self-care_hygiene');
    ...
    // Hygiene - Grooming
    const groomingFlag = getValue('current-level-function_self-care_hygiene_grooming');
    ...
    const washingBodyParts = getValue('current-level-function_self-care_hygiene_grooming_washing_body_parts');
    ...
    const washingWholeBody = getValue('current-level-function_self-care_hygiene_grooming_washing_whole_body');
    ...
    const dryingOneself = getValue('current-level-function_self-care_hygiene_grooming_drying_oneself');
    ...
    const caringForSkin = getValue('current-level-function_self-care_hygiene_grooming_caring_for_skin');
    ...
    const caringForTeeth = getValue('current-level-function_self-care_hygiene_grooming_caring_for_teeth');
    ...
    const caringForHair = getValue('current-level-function_self-care_hygiene_grooming_caring_for_hair');
    ...
    const caringForNails = getValue('current-level-function_self-care_hygiene_grooming_caring_for_nails');
    ...
    const lookingAfterHealthFlag = getValue('current-level-function_self-care_hygiene_looking_after_health');
    ...
    const balancedDiet = getValue('current-level-function_self-care_hygiene_looking_after_health_balanced_diet');
    ...
    const keepingWarm = getValue('current-level-function_self-care_hygiene_looking_after_health_keeping_warm');
    ...
    const keepingCool = getValue('current-level-function_self-care_hygiene_looking_after_health_keeping_cool');
    ...
    const immunizations = getValue('current-level-function_self-care_hygiene_looking_after_health_immunizations');
    ...
    const physicalExams = getValue('current-level-function_self-care_hygiene_looking_after_health_physical_exams');
    ...
    // Hygiene - Dressing
    const dressingFlag = getValue('current-level-function_self-care_hygiene_dressing');
    ...
    const puttingOnClothes = getValue('current-level-function_self-care_hygiene_dressing_putting_on_clothes');
    ...
    const puttingOnFootwear = getValue('current-level-function_self-care_hygiene_dressing_putting_on_footwear');
    ...
    const appropriateClothing = getValue('current-level-function_self-care_hygiene_dressing_appropriate_clothing');
    ...
    const removingClothes = getValue('current-level-function_self-care_hygiene_dressing_removing_clothes');
    ...
    const removingFootwear = getValue('current-level-function_self-care_hygiene_dressing_removing_footwear');
    ...
    // Hygiene - Bathing
    const bathingFlag = getValue('current-level-function_self-care_hygiene_bathing');
    ...
    const showering = getValue('current-level-function_self-care_hygiene_bathing_showering');
    ...
    const bathingTub = getValue('current-level-function_self-care_hygiene_bathing_bathing_tub');
    ...
    const bathingWashParts = getValue('current-level-function_self-care_hygiene_bathing_bathing_wash_parts');
    ...
    const bathingDrying = getValue('current-level-function_self-care_hygiene_bathing_bathing_drying');
    ...
    // Hygiene - Toileting
    const toiletingFlag = getValue('current-level-function_self-care_hygiene_toileting');
    ...
    const urination = getValue('current-level-function_self-care_hygiene_toileting_urination');
    ...
    const defecation = getValue('current-level-function_self-care_hygiene_toileting_defecation');
    ...
    const menstrualCare = getValue('current-level-function_self-care_hygiene_toileting_menstrual_care');
    ...
    const sleepFlag = getValue('current-level-function_self-care_sleep');
    ...
    const disturbedSleep = getValue('current-level-function_self-care_sleep_disturbed_sleep');
    ...
    const sleepingPosturesFlag = getValue('current-level-function_self-care_sleep_sleeping_postures');
    ...
    const sleepProne = getValue('current-level-function_self-care_sleep_sleeping_postures_prone');
    ...
    const sleepSupine = getValue('current-level-function_self-care_sleep_sleeping_postures_supine');
    ...
    const sleepSideRight = getValue('current-level-function_self-care_sleep_sleeping_postures_side_right');
    ...
    const sleepSideLeft = getValue('current-level-function_self-care_sleep_sleeping_postures_side_left');
    ...
    const sleepPillows = getValue('current-level-function_self-care_sleep_pillows');
    ...
    // Sleep - Surface Flag
    const surfaceFlag = getValue('current-level-function_self-care_sleep_surface');
    ...
    const sleepSurfaceFirm = getValue('current-level-function_self-care_sleep_surface_firm');
    ...
    const sleepSurfaceSoft = getValue('current-level-function_self-care_sleep_surface_soft');
    ...
    const sleepSurfaceSag = getValue('current-level-function_self-care_sleep_surface_sag');
    ...
    // Self Care - IADLs
    const iADLsFlag = getValue('current-level-function_self-care_iadls');
    ...
    const iADLsTelephone = getValue('current-level-function_self-care_iadls_use_telephone');
    ...
    const iADLsShopping = getValue('current-level-function_self-care_iadls_shopping');
    ...
    const iADLsFoodPrep = getValue('current-level-function_self-care_iadls_food_prep');
    ...
    const iADLsHousekeeping = getValue('current-level-function_self-care_iadls_housekeeping');
    ...
    const iADLsLaundry = getValue('current-level-function_self-care_iadls_laundry_iadl');
    ...
    const iADLsTransportation = getValue('current-level-function_self-care_iadls_transportation');
    ...
    const iADLsMedications = getValue('current-level-function_self-care_iadls_medications');
    ...
    const iADLsFinances = getValue('current-level-function_self-care_iadls_finances');
    ...
    const householdChoresFlag = getValue('current-level-function_self-care_household_chores');
    ...
    const householdChoresCook = getValue('current-level-function_self-care_household_chores_cook_meal');
    ...
    const householdChoresLaundry = getValue('current-level-function_self-care_household_chores_laundry_chore');
    ...
    const driveCommunity = getValue('current-level-function_self-care_drive_community');
    ...
    const volunteering = getValue('current-level-function_self-care_volunteering');
    ...
    const caregiving = getValue('current-level-function_self-care_caregiving');
