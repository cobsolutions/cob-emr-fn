...
export class StrengthMapperService {
  ...
  private mapGripPinch(dto: Strength): any {
    return {
      ...
      rapid_exchange_right_1: dto.gripPinch?.rapidExchangeData?.rapidExchangeRight1 || '',
      rapid_exchange_right_2: dto.gripPinch?.rapidExchangeData?.rapidExchangeRight2 || '',
      rapid_exchange_right_3: dto.gripPinch?.rapidExchangeData?.rapidExchangeRight3 || '',
      rapid_exchange_right_4: dto.gripPinch?.rapidExchangeData?.rapidExchangeRight4 || '',
      rapid_exchange_right_5: dto.gripPinch?.rapidExchangeData?.rapidExchangeRight5 || '',
      rapid_exchange_left_1: dto.gripPinch?.rapidExchangeData?.rapidExchangeLeft1 || '',
      rapid_exchange_left_2: dto.gripPinch?.rapidExchangeData?.rapidExchangeLeft2 || '',
      rapid_exchange_left_3: dto.gripPinch?.rapidExchangeData?.rapidExchangeLeft3 || '',
      rapid_exchange_left_4: dto.gripPinch?.rapidExchangeData?.rapidExchangeLeft4 || '',
      rapid_exchange_left_5: dto.gripPinch?.rapidExchangeData?.rapidExchangeLeft5 || '',
      rapid_exchange_cov_right: dto.gripPinch?.rapidExchangeData?.rapidExchangeCovRight || '',
      rapid_exchange_cov_left: dto.gripPinch?.rapidExchangeData?.rapidExchangeCovLeft || '',
      rapid_exchange_avg_right: dto.gripPinch?.rapidExchangeData?.rapidExchangeAvgRight || '',
      rapid_exchange_avg_left: dto.gripPinch?.rapidExchangeData?.rapidExchangeAvgLeft || '',
      rapid_exchange_comments_right: dto.gripPinch?.rapidExchangeData?.rapidExchangeCommentsRight || '',
      rapid_exchange_comments_left: dto.gripPinch?.rapidExchangeData?.rapidExchangeCommentsLeft || '',
      repeated_grip: dto.gripPinch?.repeatedGrip ? 'yes' : 'no',
      repeated_grip_right_1: dto.gripPinch?.repeatedGripData?.repeatedGripRight1 || '',
      repeated_grip_right_2: dto.gripPinch?.repeatedGripData?.repeatedGripRight2 || '',
      repeated_grip_right_3: dto.gripPinch?.repeatedGripData?.repeatedGripRight3 || '',
      repeated_grip_right_4: dto.gripPinch?.repeatedGripData?.repeatedGripRight4 || '',
      repeated_grip_right_5: dto.gripPinch?.repeatedGripData?.repeatedGripRight5 || '',
      repeated_grip_left_1: dto.gripPinch?.repeatedGripData?.repeatedGripLeft1 || '',
      repeated_grip_left_2: dto.gripPinch?.repeatedGripData?.repeatedGripLeft2 || '',
      repeated_grip_left_3: dto.gripPinch?.repeatedGripData?.repeatedGripLeft3 || '',
      repeated_grip_left_4: dto.gripPinch?.repeatedGripData?.repeatedGripLeft4 || '',
      repeated_grip_left_5: dto.gripPinch?.repeatedGripData?.repeatedGripLeft5 || '',
      repeated_grip_cov_right: dto.gripPinch?.repeatedGripData?.repeatedGripCovRight || '',
      repeated_grip_cov_left: dto.gripPinch?.repeatedGripData?.repeatedGripCovLeft || '',
      repeated_grip_avg_right: dto.gripPinch?.repeatedGripData?.repeatedGripAvgRight || '',
      repeated_grip_avg_left: dto.gripPinch?.repeatedGripData?.repeatedGripAvgLeft || '',
      repeated_grip_comments_right: dto.gripPinch?.repeatedGripData?.repeatedGripCommentsRight || '',
      repeated_grip_comments_left: dto.gripPinch?.repeatedGripData?.repeatedGripCommentsLeft || '',
      five_level_grip: dto.gripPinch?.fiveLevelGrip ? 'yes' : 'no',
      five_level_grip_right_1: dto.gripPinch?.fiveLevelGripData?.fiveLevelGripRight1 || '',
      five_level_grip_right_2: dto.gripPinch?.fiveLevelGripData?.fiveLevelGripRight2 || '',
      five_level_grip_right_3: dto.gripPinch?.fiveLevelGripData?.fiveLevelGripRight3 || '',
      five_level_grip_right_4: dto.gripPinch?.fiveLevelGripData?.fiveLevelGripRight4 || '',
      five_level_grip_right_5: dto.gripPinch?.fiveLevelGripData?.fiveLevelGripRight5 || '',
      five_level_grip_left_1: dto.gripPinch?.fiveLevelGripData?.fiveLevelGripLeft1 || '',
      five_level_grip_left_2: dto.gripPinch?.fiveLevelGripData?.fiveLevelGripLeft2 || '',
      five_level_grip_left_3: dto.gripPinch?.fiveLevelGripData?.fiveLevelGripLeft3 || '',
      five_level_grip_left_4: dto.gripPinch?.fiveLevelGripData?.fiveLevelGripLeft4 || '',
      five_level_grip_left_5: dto.gripPinch?.fiveLevelGripData?.fiveLevelGripLeft5 || '',
      five_level_grip_cov_right: dto.gripPinch?.fiveLevelGripData?.fiveLevelGripCovRight || '',
      five_level_grip_cov_left: dto.gripPinch?.fiveLevelGripData?.fiveLevelGripCovLeft || '',
      five_level_grip_avg_right: dto.gripPinch?.fiveLevelGripData?.fiveLevelGripAvgRight || '',
      five_level_grip_avg_left: dto.gripPinch?.fiveLevelGripData?.fiveLevelGripAvgLeft || '',
      five_level_grip_comments_right: dto.gripPinch?.fiveLevelGripData?.fiveLevelGripCommentsRight || '',
      five_level_grip_comments_left: dto.gripPinch?.fiveLevelGripData?.fiveLevelGripCommentsLeft || '',
    };
  }
  ...
  toModel(formValue: any): Strength {
    ...
    const gripPinch: GripPinch = {
      ...
      rapidExchangeData: {
        rapidExchangeRight1: formValue.rapid_exchange_right_1 || '',
        rapidExchangeRight2: formValue.rapid_exchange_right_2 || '',
        rapidExchangeRight3: formValue.rapid_exchange_right_3 || '',
        rapidExchangeRight4: formValue.rapid_exchange_right_4 || '',
        rapidExchangeRight5: formValue.rapid_exchange_right_5 || '',
        rapidExchangeLeft1: formValue.rapid_exchange_left_1 || '',
        rapidExchangeLeft2: formValue.rapid_exchange_left_2 || '',
        rapidExchangeLeft3: formValue.rapid_exchange_left_3 || '',
        rapidExchangeLeft4: formValue.rapid_exchange_left_4 || '',
        rapidExchangeLeft5: formValue.rapid_exchange_left_5 || '',
        rapidExchangeCovRight: formValue.rapid_exchange_cov_right || '',
        rapidExchangeCovLeft: formValue.rapid_exchange_cov_left || '',
        rapidExchangeAvgRight: formValue.rapid_exchange_avg_right || '',
        rapidExchangeAvgLeft: formValue.rapid_exchange_avg_left || '',
        rapidExchangeCommentsRight: formValue.rapid_exchange_comments_right || '',
        rapidExchangeCommentsLeft: formValue.rapid_exchange_comments_left || '',
      },
      repeatedGrip: formValue.repeated_grip === 'yes',
      repeatedGripData: {
        repeatedGripRight1: formValue.repeated_grip_right_1 || '',
        repeatedGripRight2: formValue.repeated_grip_right_2 || '',
        repeatedGripRight3: formValue.repeated_grip_right_3 || '',
        repeatedGripRight4: formValue.repeated_grip_right_4 || '',
        repeatedGripRight5: formValue.repeated_grip_right_5 || '',
        repeatedGripLeft1: formValue.repeated_grip_left_1 || '',
        repeatedGripLeft2: formValue.repeated_grip_left_2 || '',
        repeatedGripLeft3: formValue.repeated_grip_left_3 || '',
        repeatedGripLeft4: formValue.repeated_grip_left_4 || '',
        repeatedGripLeft5: formValue.repeated_grip_left_5 || '',
        repeatedGripCovRight: formValue.repeated_grip_cov_right || '',
        repeatedGripCovLeft: formValue.repeated_grip_cov_left || '',
        repeatedGripAvgRight: formValue.repeated_grip_avg_right || '',
        repeatedGripAvgLeft: formValue.repeated_grip_avg_left || '',
        repeatedGripCommentsRight: formValue.repeated_grip_comments_right || '',
        repeatedGripCommentsLeft: formValue.repeated_grip_comments_left || '',
      },
      fiveLevelGrip: formValue.five_level_grip === 'yes',
      fiveLevelGripData: {
        fiveLevelGripRight1: formValue.five_level_grip_right_1 || '',
        fiveLevelGripRight2: formValue.five_level_grip_right_2 || '',
        fiveLevelGripRight3: formValue.five_level_grip_right_3 || '',
        fiveLevelGripRight4: formValue.five_level_grip_right_4 || '',
        fiveLevelGripRight5: formValue.five_level_grip_right_5 || '',
        fiveLevelGripLeft1: formValue.five_level_grip_left_1 || '',
        fiveLevelGripLeft2: formValue.five_level_grip_left_2 || '',
        fiveLevelGripLeft3: formValue.five_level_grip_left_3 || '',
        fiveLevelGripLeft4: formValue.five_level_grip_left_4 || '',
        fiveLevelGripLeft5: formValue.five_level_grip_left_5 || '',
        fiveLevelGripCovRight: formValue.five_level_grip_cov_right || '',
        fiveLevelGripCovLeft: formValue.five_level_grip_cov_left || '',
        fiveLevelGripAvgRight: formValue.five_level_grip_avg_right || '',
        fiveLevelGripAvgLeft: formValue.five_level_grip_avg_left || '',
        fiveLevelGripCommentsRight: formValue.five_level_grip_comments_right || '',
        fiveLevelGripCommentsLeft: formValue.five_level_grip_comments_left || '',
      }
    };
