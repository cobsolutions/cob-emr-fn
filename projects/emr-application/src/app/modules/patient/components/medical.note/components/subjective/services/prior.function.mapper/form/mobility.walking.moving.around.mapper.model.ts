...
export class MobilityWalkingMovingAroundMapper{
    public static map(formGroup: FormGroup, mapped: PriorFunction, getValue: (controlName: string) => any): void {
        ...
        const mobilityWalkingMovingAroundFlag = getValue('prior-level-function_mobility-walking-moving-around');
        ...
        const movingAroundUsingEquipmentFlag = getValue('prior-level-function_mobility-walking-moving-around_different_locations_using_equipment');
        if (movingAroundUsingEquipmentFlag !== undefined) {
          ...
          mapped.mobilityWalkingMovingAround.movingAroundInDifferentLocations.movingAroundUsingEquipment.movingAroundUsingEquipmentFlag = walkingBetweenRoomsFlag;
        }
        ...
        const movingAroundUsingTransportationFlag = getValue('prior-level-function_mobility-walking-moving-around_different_locations_using_transportation');
        if (movingAroundUsingTransportationFlag !== undefined) {
          ...
          mapped.mobilityWalkingMovingAround.movingAroundInDifferentLocations.movingAroundUsingTransportation.movingAroundUsingTransportationFlag = walkingBetweenRoomsFlag;
        }
